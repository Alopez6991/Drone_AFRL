...
class Mpc_Smd:
    def __init__(self,vx,x=None,x0=None, dt=0.01, n_horizon=20, r_weight=1e-10, run=True):
        ...
        self.model.set_rhs('vx', -k/m * x - b/m * vx + U1/m)
...
print('Hello from spring_mas_damp.py')